...
export const TASKS: TaskDefinition[] = [
  {
    ...
    badge: "Mission 1",
    title: "Je m'habille",
    description: "Tenue prête, super départ.",
    confirmCopy: "La tenue est prête ?",
  ...
  },
  {
    ...
    badge: "Mission 3",
    title: "Je bois",
    description: "Un verre d'eau pour l'énergie.",
  ...
  },
  {
    ...
    badge: "Mission 4",
    title: "Je bouge",
    description: "10 sauts ou un mini défi.",
...
export const REWARD_OPTIONS: RewardDefinition[] = [
  {
    ...
    note: "Une petite surprise de famille. Parfois, c'est juste un grand bravo.",
    accent: "#C9783F",
    threshold: 1,
  },
  {
    ...
    label: "2 matins",
    title: "Bonus à choisir",
    note: "Un bonus choisi avec papa ou maman.",
    accent: "#7893C7",
    threshold: 2,
  },
  {
    ...
    label: "7 matins",
    title: "Grande récompense",
    note: "Une sortie, un jouet ou un repas préféré.",
    accent: "#D69B00",
    threshold: 7,
  },
];
